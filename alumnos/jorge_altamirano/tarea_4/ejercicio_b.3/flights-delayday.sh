...
export PIG_FILE=/dfs/ejercicio_b.3/flights-delayday.pig
export  PIG_OUT=/tarea_4/ejercicio_b.3
...
hdfs dfs -copyToLocal $PIG_OUT/part-r-00000 /dfs/ejercicio_b.3/output.txt
echo
echo "End!"
