...
Descargamos la base de datos desde dropbox con la siguiente url:

https://www.dropbox.com/sh/u0g3g378xfdyxot/AACN77EAFN1rjNkPemkX-PWZa?dl=0
...
La url del github es la siguiente: 
...
docker run -it -v $PWD/tarea2:/home/data sequenceiq/hadoop-docker:2.7.1 /etc/bootstrap.sh -bash
...
Verificamos que esté vacío mediante el comando
...
bin/hdfs dfs -copyFromLocal /home/data/ecobici_2017_sem1.csv /metodos_gran_escala/tarea_2/ecobici/year=2017/sem_1/

![Copiamos desde local al HDFS](images/copyLocal.png)
...
bin/hdfs dfs -cat /metodos_gran_escala/tarea_2/ecobici/year=2017/sem_1/ecobici_2017_sem1.csv | head -10
...
![Verificamos Hadoop y YARN estén levantados](images/jps.png)
...
y vemos que se ha utilizado el 3.21% del HDFS
