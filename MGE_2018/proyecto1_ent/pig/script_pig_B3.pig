...
datos_cont_imecas = foreach datos_cont_sin2 generate date,id_station,id_parameter,value,unit,(
    case id_parameter
      ...
      when 'O3' then (0.001*value*100)/0.11
...
cont_bajo = order datos_cont_imecas by imeca ASC;
cero = filter datos_cont_imecas by value==0;
respuesta_b3 = join cero by $1, base_estaciones by clave;
respuesta_b3 = foreach respuesta_b3 generate $0 as date, $2 as id_parameter, $3 as value, $6 as id_station, $7 as nombre, $9 as entidad, $5 as imeca;



STORE respuesta_b3 INTO 's3://aws-alex-03032018-metodos-gran-escala/output/pig_b3' USING org.apache.pig.piggybank.storage.CSVExcelStorage(',', 'NO_MULTILINE', 'UNIX', 'WRITE_OUTPUT_HEADER');
