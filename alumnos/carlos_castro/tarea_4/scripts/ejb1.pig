...
flights_obj = filter flights by DESTINATION_AIRPORT == 'HNL';

group_orders = group flights_obj by DESTINATION_AIRPORT;
count_products = FOREACH group_orders GENERATE COUNT($1) as n;
